...
public class Professor extends Employee 
{
		...
		public Professor(String data1, int data2, String data3, String data4, Long data5, Long data6)
			{
			basicpay=0;
		}
		public Professor(String n,int id,String ad,String mail,Long mob,int bp)
			{
