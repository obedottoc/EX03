...
public class AsisstantProfessor extends Employe {
	private double Basic_Pay;
	
	public AsisstantProfessor()
	{
		Basic_Pay=0;
	}
	public AsisstantProfessor(String name,long id,String add,String mail,long mobile,double bp)
	{
