...
public class AssociateProffessor extends Employee {
    
	private double Basic_Pay;
	
	public AssociateProffessor()
		{
			Basic_Pay=0;
		}
	
	public AssociateProffessor(String n,long id, String ad,String mail,long no,double bp)
	{
