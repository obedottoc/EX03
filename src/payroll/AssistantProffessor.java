...
public class AssistantProffessor extends Employee {
	private double Basic_Pay;
	
	public AssistantProffessor()
	{
		Basic_Pay=0;
	}
	public AssistantProffessor(String name,long id,String add,String mail,long mobile,double bp)
	{
